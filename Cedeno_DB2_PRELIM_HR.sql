...
***************************CREATING TABLES************************
**************************************************************** */
CREATE TABLE "cedeno_hr".regions (
	region_id numeric(11,0)  NOT NULL,
	region_name VARCHAR(25),
	PRIMARY KEY (region_id)
	);
------------------
CREATE TABLE "cedeno_hr".countries (
...
CREATE TABLE "cedeno_hr".locations (
...
CREATE TABLE "cedeno_hr".departments (
...
CREATE TABLE "cedeno_hr".employees (
...
CREATE TABLE "cedeno_hr".job_history (
	employee_id numeric(11,0)  NOT NULL,
...
ALTER TABLE "cedeno_hr".job_history
 ADD UNIQUE  (
	employee_id,
	start_date
	);
...
SELECT e.employee_id,
	...
	c.country_name,
	r.region_name
FROM  "cedeno_hr".employees e,
	 "cedeno_hr".departments d,
	 "cedeno_hr".jobs j,
	 "cedeno_hr".locations l,
	 "cedeno_hr".countries c,
	 "cedeno_hr".regions r
...
INSERT INTO "cedeno_hr".countries
VALUES (
	'IT',
	'Italy',
	1
...
INSERT INTO "cedeno_hr".locations
VALUES (
	1000,
...
INSERT INTO "cedeno_hr".departments
VALUES (
	10,
	'Administration',
	200,
...
INSERT INTO "cedeno_hr".employees
VALUES (
	100,
	'Steven',
	'King',
...
INSERT INTO "cedeno_hr".employees VALUES
(	207,
	'Joseph',
	 'Cedeño',
	 'josephgcedeno@gmail.com',
	 '09123456789',
	TO_DATE('16-JAN-2020', '%d-%M-%Y'),
	'IT_PROG',
	15000,
	'Lex Dehaan',
	90)
...
INSERT INTO "cedeno_hr".job_history
VALUES (
	102,
	TO_DATE('13-Jan-1993', '%d-%M-%Y'),
...
ALTER TABLE "cedeno_hr".countries ADD FOREIGN KEY (region_id) REFERENCES "cedeno_hr".regions(region_id);    
ALTER TABLE "cedeno_hr".locations ADD FOREIGN KEY (country_id) REFERENCES "cedeno_hr".countries(country_id);
ALTER TABLE "cedeno_hr".departments ADD FOREIGN KEY (location_id) REFERENCES "cedeno_hr".locations(location_id);
ALTER TABLE "cedeno_hr".employees ADD FOREIGN KEY (job_id) REFERENCES "cedeno_hr".jobs(job_id);
ALTER TABLE "cedeno_hr".employees ADD FOREIGN KEY (department_id) REFERENCES "cedeno_hr".departments(department_id);
ALTER TABLE "cedeno_hr".employees ADD FOREIGN KEY (manager_id) REFERENCES "cedeno_hr".employees(employee_id);
ALTER TABLE "cedeno_hr".departments ADD FOREIGN KEY (manager_id) REFERENCES "cedeno_hr".employees (employee_id);
ALTER TABLE "cedeno_hr".job_history ADD FOREIGN KEY (employee_id) REFERENCES "cedeno_hr".employees(employee_id);
ALTER TABLE "cedeno_hr".job_history ADD FOREIGN KEY (job_id) REFERENCES "cedeno_hr".jobs(job_id);
ALTER TABLE "cedeno_hr".job_history ADD FOREIGN KEY (department_id) REFERENCES "cedeno_hr".departments(department_id);